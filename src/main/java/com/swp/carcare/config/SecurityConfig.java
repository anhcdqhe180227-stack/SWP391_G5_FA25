    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .authorizeHttpRequests(at -> at.requestMatchers("/", "/home", "/appointment/**", "/login/**", "/loginError/**", "/login-google", "/register", "/save", "re-send", "/image/**", "/js/**", "/css/**", "/lib/**", "/style/**", "/slider/**", "/assets/**",
                                ...
                                "/assets/**", "/assets_admin/**", "/about/**", "/service/**", "/index", "/index/**", "/fonts/**", "/product/**", "/guest/**", "/doctors", "/doctors/**", "/404").permitAll()
                        ...
                        .requestMatchers("/employee/**").hasAnyRole("EMP")
                        .requestMatchers("/recep/**").hasAnyRole("RECEP")
